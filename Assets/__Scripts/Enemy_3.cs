...
public class Enemy_3 : Enemy
{
    ...
    void Start()
    {
        ...
        // Начальная позиция из Main.SpawnEnemy()
        points[0] = pos;
        // Установить xMin и xMax
        float xMin = -bndCheck.camWidth + bndCheck.radius;
        float xMax = bndCheck.camWidth - bndCheck.radius;
        Vector3 v;
        // Случайно выбрать нижнюю точку ниже нижней границы экрана
        v = Vector3.zero;
    ...
    public override void Move()
    {
        ...
        // Интерполировать кривую Безье по 3 точкам
        Vector3 p01, p12;
